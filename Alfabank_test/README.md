Тестовое задание выполнено Касинским Дмитрием Юрьевичем:
1. Язык программирования - `JavaScript`;
2. Инструмент написания автотестов - `Playwright`;
...
- Зайти в папку Alfabank_test
- Открыть терминал
- Ввести команду `npm init playwright@latest`
    Выбрать:
    - JavaScript
    - e2e
    - false(N)
    - false(n)
    - false(N)
8. Запуск автотестов следует запускать последовательно путем запуска командой: `npx playwright test --ui`;
